                ...
                <div class="panel-body">
                              ...
                              <div class="card-block">
                                  ...
                                  <section class="example mt-4">  
                                    ...
                                    <form id="actualizar" onsubmit="actualizar(); return false;">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <p class="img">
                                          ...
                                          <br>
                                          <img class="img-fluid mt-2" id="img" width="50%">
                                        </p>
          ...
          .then(function(snapshot) {
            ...
            snapshot.forEach(function(data){
              ...
              if (id == key) {
                ...
                // Variable Global de la URL de la imagen actual, la uso en la función actualizar() 
                window.imgfs = img;
            ...
            .then(function(snapshot) {
              ...
              snapshot.forEach(function(data){
                ...
                if (id == key) {
                  ...
                  // Verifico si el objeto del archivo (imagen), no esta vacio 
                  if (window.value != null) {

                    // Obtengo la imagen actual (Hago extracción del nombre de la imagen en la URL) 
                    var str = window.imgfs;
                    var n = str.split('%2F').pop().split('#').shift().split('?').shift();
                    //var n = str.split('/').pop().split('?')[0];

                    console.log(n);
                    console.log(str);

                    // Hago referencia a Firebase Storage 
                    var storage_eli = firebase.storage(); 
                    var storageRef_eli = storage_eli.ref();

                    // Hago referencia a la ruta del archivo almacenado en Firebase Storage 
                    var desertRef = storageRef_eli.child('crud_firebase_bootstrap/uploads/' + n);
                    ...
                    // Subo la nueva imagen a Firebase Storage con el método put() 
                    ...
                    archivoRef.put(window.value).then(function(snapshot) {
                      console.log('Imagen Subida a Firebase Storage !');
                        ...
                        archivoRef.getDownloadURL().then(function(downloadURL) {
                            ...
                            window.urlimagen = downloadURL; 

                            // Hacemos referencia a Firebase Realtime Database 
                            var database = firebase.database(); 

                            // Defino la ruta '/postres' con el 'id' del registro en la base de datos Realtime Database 
                            const ref = database.ref('postres/' + id);           
                            ...
                            ref.update({
                              ...
                              precio: precio,
                              stock: stock,
                              img: window.urlimagen 
                            });

                            // Redireccionamos con mensaje 
                            var msg = "Actualizado Satisfactoriamente !"; 
                      ...
                      // Actaulizo los datos en en la base de datos Realtime Database 
                      ref.update({
                        nombre: nombre,
                        precio: precio,
                        stock: stock,
